export default function Home() {
  return (
    <div className="bg-black text-white font-sans">
      {/* Hero Section */}
      <section className="min-h-screen flex flex-col justify-center items-center px-6 pt-20 pb-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Turn Fidgeting Into Rewards</h1>
